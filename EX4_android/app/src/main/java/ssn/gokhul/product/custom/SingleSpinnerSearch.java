...
import ssn.gokhul.product.BrandActivity;
import ssn.gokhul.product.InsertActivity;
import ssn.gokhul.product.MainActivity;
import ssn.gokhul.product.R;
	...
	public boolean performClick() {
		...
		builder.setNegativeButton("Add", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialogInterface, int i) {
				if(getContext().toString().contains("InsertActivity") || getContext().toString().contains("RetrieveAllActivity")){
					Intent brand = new Intent(getContext(), BrandActivity.class);
					listener.onClear();
					getContext().startActivity(brand);
				}
				if(getContext().toString().contains("UpdateActivity") || getContext().toString().contains("DeleteActivity") || getContext().toString().contains("RetrieveIDActivity")){
					Intent insert = new Intent(getContext(), InsertActivity.class);
					listener.onClear();
					getContext().startActivity(insert);
				}
